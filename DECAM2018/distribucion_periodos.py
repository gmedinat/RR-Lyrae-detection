...
indir  = "/run/media/gmedina/TOSHIBA EXT/DECam2018/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Color_cut_test/Filtrados_duplicates" 
files = os.listdir("/run/media/gmedina/TOSHIBA EXT/DECam2018/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Color_cut_test/Filtrados_duplicates")
...
plt.hist(P2, bins=200)  # arguments are passed to np.histogram 
...
plt.xlabel('Period 2', fontsize=20)
plt.ylabel('N', fontsize=20)

plt.tight_layout()
if save == True:
	#plt.savefig('histogram_P2.eps')
	#plt.savefig('histogram_P2.png')
	plt.savefig('histogram_P4J_P2.png')
