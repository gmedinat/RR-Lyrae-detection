...
filtro = 'r'
catalogo_referencia = 4

i=1
while i<=24:

	archivo_list = glob.glob("/run/media/gmedina/TOSHIBA EXT/DECam2018/Data/RR%s/RR%s_%s_*_%s.csv"%(i,i,catalogo_referencia,filtro))
...
big_df.to_csv( '/run/media/gmedina/TOSHIBA EXT/DECam2018/Data/All_Fields_ref_%s.csv'%filtro )
del big_df
