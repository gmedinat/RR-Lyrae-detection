...
f = "/run/media/gmedina/TOSHIBA EXT/DECam2018/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Color_cut_test/001Tabla.csv"
df = pd.read_csv(f)
...
big_df_duplicates_removed.to_csv( "/run/media/gmedina/TOSHIBA EXT/DECam2018/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Color_cut_test/001Tabla_filtrada.csv" )
