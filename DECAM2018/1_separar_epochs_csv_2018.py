...
files = os.listdir("/run/media/gmedina/TOSHIBA EXT/DECam2018/Data")
...
while count <= 24 :
	...
	outdir = "/run/media/gmedina/TOSHIBA EXT/DECam2018/Data/RR%s"%file_n
	...
	while i < len(diff_epochs):
		...
		sub_tabla.to_csv(outdir+"/RR%s_%s_%s_%s.csv"%(file_n,epoca, diff_epochs[i], band))
