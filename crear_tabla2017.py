...
files = glob.glob("/run/media/gmedina/TOSHIBA EXT/DECam2017/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Selected/Selected_si/*.csv") 
...
np.savetxt( "/run/media/gmedina/TOSHIBA EXT/DECam2017/datos_leftraru/Estrellas_Gen_All_Periods_P4J/Selected/Selected_si/Tabla_si.dat", Matriz, fmt='%s',delimiter="   ", header='RA \t DEC \t Field \t CCD \t CCDnum \t object_id \t period1 \t period2 \t N_r \t N_g \t amplitud_total \t mean_mag_rel_cal_r \t mean_mag_rel_cal_g \t mean_mag_rel_cal_g-mean_mag_rel_cal_r \t g_r_distance')
