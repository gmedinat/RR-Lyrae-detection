...
indir  = "/run/media/gmedina/TOSHIBA EXT/DECam2017/Data/Fields_with_uncalibrated_magnitudes" 
outdir = "/run/media/gmedina/TOSHIBA EXT/DECam2017/Data/Fields_with_uncalibrated_magnitudes/PerCCD" 
