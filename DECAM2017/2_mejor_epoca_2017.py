...
while campo <=16:
	...
	# Field1_1_57992.13009762_g.csv
	# Field10_1_57992.13009762_g.csv
	# Field1_29_XXXXXXXXXXXXXX_g.csv
	# Field10_29_XXXXXXXXXXXXXX_g.csv
	...
	np.savetxt( "/run/media/gmedina/TOSHIBA EXT/DECam2017/Data/mean_rad_Field_%s_%s.dat"%(campo, filtro), Matriz, fmt='%s',delimiter="   ", header='MJD \t Obs \t mean_rad')
